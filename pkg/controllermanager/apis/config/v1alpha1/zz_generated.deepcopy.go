...
func (in *ControllerManagerControllerConfiguration) DeepCopyInto(out *ControllerManagerControllerConfiguration) {
	*out = *in
	...
	if in.SeedBinding != nil {
		in, out := &in.SeedBinding, &out.SeedBinding
		*out = new(SeedBindingControllerConfiguration)
		(*in).DeepCopyInto(*out)
	}
	if in.Seed != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SeedBindingControllerConfiguration) DeepCopyInto(out *SeedBindingControllerConfiguration) {
	*out = *in
	if in.ConcurrentSyncs != nil {
		in, out := &in.ConcurrentSyncs, &out.ConcurrentSyncs
		*out = new(int)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SeedBindingControllerConfiguration.
func (in *SeedBindingControllerConfiguration) DeepCopy() *SeedBindingControllerConfiguration {
	if in == nil {
		return nil
	}
	out := new(SeedBindingControllerConfiguration)

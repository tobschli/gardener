...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*SeedBinding)(nil), (*core.SeedBinding)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_SeedBinding_To_core_SeedBinding(a.(*SeedBinding), b.(*core.SeedBinding), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*core.SeedBinding)(nil), (*SeedBinding)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_core_SeedBinding_To_v1beta1_SeedBinding(a.(*core.SeedBinding), b.(*SeedBinding), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*SeedBindingList)(nil), (*core.SeedBindingList)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_SeedBindingList_To_core_SeedBindingList(a.(*SeedBindingList), b.(*core.SeedBindingList), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*core.SeedBindingList)(nil), (*SeedBindingList)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_core_SeedBindingList_To_v1beta1_SeedBindingList(a.(*core.SeedBindingList), b.(*SeedBindingList), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1beta1_SeedBinding_To_core_SeedBinding(in *SeedBinding, out *core.SeedBinding, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
	out.TaintSeed = in.TaintSeed
	out.SeedSelector = (*core.SeedSelector)(unsafe.Pointer(in.SeedSelector))
	return nil
}

// Convert_v1beta1_SeedBinding_To_core_SeedBinding is an autogenerated conversion function.
func Convert_v1beta1_SeedBinding_To_core_SeedBinding(in *SeedBinding, out *core.SeedBinding, s conversion.Scope) error {
	return autoConvert_v1beta1_SeedBinding_To_core_SeedBinding(in, out, s)
}

func autoConvert_core_SeedBinding_To_v1beta1_SeedBinding(in *core.SeedBinding, out *SeedBinding, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
	out.TaintSeed = in.TaintSeed
	out.SeedSelector = (*SeedSelector)(unsafe.Pointer(in.SeedSelector))
	return nil
...
// Convert_core_SeedBinding_To_v1beta1_SeedBinding is an autogenerated conversion function.
func Convert_core_SeedBinding_To_v1beta1_SeedBinding(in *core.SeedBinding, out *SeedBinding, s conversion.Scope) error {
	return autoConvert_core_SeedBinding_To_v1beta1_SeedBinding(in, out, s)
}

func autoConvert_v1beta1_SeedBindingList_To_core_SeedBindingList(in *SeedBindingList, out *core.SeedBindingList, s conversion.Scope) error {
	out.ListMeta = in.ListMeta
	out.Items = *(*[]core.SeedBinding)(unsafe.Pointer(&in.Items))
	return nil
}

// Convert_v1beta1_SeedBindingList_To_core_SeedBindingList is an autogenerated conversion function.
func Convert_v1beta1_SeedBindingList_To_core_SeedBindingList(in *SeedBindingList, out *core.SeedBindingList, s conversion.Scope) error {
	return autoConvert_v1beta1_SeedBindingList_To_core_SeedBindingList(in, out, s)
}

func autoConvert_core_SeedBindingList_To_v1beta1_SeedBindingList(in *core.SeedBindingList, out *SeedBindingList, s conversion.Scope) error {
	out.ListMeta = in.ListMeta
	out.Items = *(*[]SeedBinding)(unsafe.Pointer(&in.Items))
	return nil
}

// Convert_core_SeedBindingList_To_v1beta1_SeedBindingList is an autogenerated conversion function.
func Convert_core_SeedBindingList_To_v1beta1_SeedBindingList(in *core.SeedBindingList, out *SeedBindingList, s conversion.Scope) error {
	return autoConvert_core_SeedBindingList_To_v1beta1_SeedBindingList(in, out, s)
}

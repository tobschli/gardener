...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*ProvisioningRequests)(nil), (*core.ProvisioningRequests)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_ProvisioningRequests_To_core_ProvisioningRequests(a.(*ProvisioningRequests), b.(*core.ProvisioningRequests), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*core.ProvisioningRequests)(nil), (*ProvisioningRequests)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_core_ProvisioningRequests_To_v1beta1_ProvisioningRequests(a.(*core.ProvisioningRequests), b.(*ProvisioningRequests), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1beta1_ClusterAutoscaler_To_core_ClusterAutoscaler(in *ClusterAutoscaler, out *core.ClusterAutoscaler, s conversion.Scope) error {
	...
	out.ProvisioningRequests = (*core.ProvisioningRequests)(unsafe.Pointer(in.ProvisioningRequests))
	return nil
}
...
func autoConvert_core_ClusterAutoscaler_To_v1beta1_ClusterAutoscaler(in *core.ClusterAutoscaler, out *ClusterAutoscaler, s conversion.Scope) error {
	...
	out.IgnoreDaemonsetsUtilization = (*bool)(unsafe.Pointer(in.IgnoreDaemonsetsUtilization))
	out.Verbosity = (*int32)(unsafe.Pointer(in.Verbosity))
	out.ProvisioningRequests = (*ProvisioningRequests)(unsafe.Pointer(in.ProvisioningRequests))
	return nil
}
...
func autoConvert_v1beta1_ProvisioningRequests_To_core_ProvisioningRequests(in *ProvisioningRequests, out *core.ProvisioningRequests, s conversion.Scope) error {
	out.Enabled = in.Enabled
	return nil
}

// Convert_v1beta1_ProvisioningRequests_To_core_ProvisioningRequests is an autogenerated conversion function.
func Convert_v1beta1_ProvisioningRequests_To_core_ProvisioningRequests(in *ProvisioningRequests, out *core.ProvisioningRequests, s conversion.Scope) error {
	return autoConvert_v1beta1_ProvisioningRequests_To_core_ProvisioningRequests(in, out, s)
}

func autoConvert_core_ProvisioningRequests_To_v1beta1_ProvisioningRequests(in *core.ProvisioningRequests, out *ProvisioningRequests, s conversion.Scope) error {
	out.Enabled = in.Enabled
	return nil
}

// Convert_core_ProvisioningRequests_To_v1beta1_ProvisioningRequests is an autogenerated conversion function.
func Convert_core_ProvisioningRequests_To_v1beta1_ProvisioningRequests(in *core.ProvisioningRequests, out *ProvisioningRequests, s conversion.Scope) error {
	return autoConvert_core_ProvisioningRequests_To_v1beta1_ProvisioningRequests(in, out, s)
}
